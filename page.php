...
$page_layout_meta = Bytesed_Group_Fields_Value::page_layout('bytesed');
$page_container_meta = Bytesed_Group_Fields_Value::page_container('bytesed','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area bytesed-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?>">
